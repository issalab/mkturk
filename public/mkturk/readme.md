...
*REWARD OPTIONS*
___________________________________________________________________________
NoFeedback (default = 0 --> dispense reward/punish): TASK.NoFeedback > 0 will skip the reward/punish screens and thus subject will not know if response was correct/incorrect.
